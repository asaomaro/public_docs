...
- schema ≥ 9 の検査: **light の上流 4 文書の実在**。`profile: light` は `design` / `tasks` を
  ...
  **light では構造的に一度も走らなかった**——`requirements.md` だけ書いた light work が
  ...
  丸ごと欠けていた。`requirements` の承認をもって 4 文書を要求する。
